...
Oh My Zsh is a framework for managing your Zsh configuration. It provides helpful plugins and themes to enhance your terminal experience. Install it by running the command provided on the [Oh My Zsh website](https://ohmyz.sh) in your terminal.

<Callout type="info">
This step is optional. If you prefer to customise your shell manually or use a different framework, you can skip this.
</Callout>
