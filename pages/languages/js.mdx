...
- [`no-restricted-syntax`](https://eslint.org/docs/latest/rules/no-restricted-syntax) - This rule is left untouched to airbnb's rules, `for..in` loops are disallowed as they introduce unexpected behaviour since they loop over the entire prototype chain.
